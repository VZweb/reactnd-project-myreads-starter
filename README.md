...
The app provides a search functionality for searching books. If a book is already on a shelf then its status also appears in the search results. 

The project was boostraped with create-react-app. 
